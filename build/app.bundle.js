...
var _internetcustomer = __webpack_require__(7);
...
var _withoutpromises = __webpack_require__(9);

var _withpromises = __webpack_require__(10);
...
Promise.all([heavyWorker1.process(200), heavyWorker2.process(200)]).then(function (data) {
    return console.log('Both successfully completed...' + JSON.stringify(data));
}, function (error) {
    return console.log('One of the workers failed...' + JSON.stringify(error));
});
...
processOrder = new Proxy(processOrder, {
    apply: function apply(target, currenthandler, args) {
        var alreadyProcessedOrders = ['ORD1', 'ORD2', 'ORD3'];
